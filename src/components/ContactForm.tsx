	...
	return (
		<form role="form" onSubmit={handleSubmit}>
			...
			<div className="bg-gray-100 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
				...
				<button
					type="button"
					className="cursor-pointer mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs inset-ring inset-ring-gray-300 hover:bg-gray-200/75 sm:mt-0 sm:w-auto"
					onClick={onClose}
				>
					Cancel
				</button>
